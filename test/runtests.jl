...
@testset "SPICE" begin
    ...
    @stress 10 include("a.jl")
    @stress 10 include("b.jl")
    @stress 10 include("c.jl")
    @stress 10 include("d.jl")
    @stress 10 include("e.jl")
    @stress 10 include("f.jl")
    @stress 10 include("g.jl")
    @stress 10 include("h.jl")
    @stress 10 include("i.jl")
    @stress 10 include("j.jl")
    @stress 10 include("k.jl")
    @stress 10 include("l.jl")
    @stress 10 include("m.jl")
    @stress 10 include("n.jl")
    @stress 10 include("o.jl")
    @stress 10 include("p.jl")
    @stress 10 include("q.jl")
    @stress 10 include("r.jl")
    @stress 10 include("s.jl")
    @stress 10 include("t.jl")
    @stress 10 include("u.jl")
    @stress 10 include("v.jl")
    @stress 10 include("w.jl")
    @stress 10 include("x.jl")
end
