...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "julia> import Pkg; Pkg.add(\"SPICE\")"
},
...
{
    "location": "#Notable-differences-to-CSPICE-1",
    "page": "Home",
    "title": "Notable differences to CSPICE",
    "category": "section",
    "text": "SPICE.jl follows the Julia language\'s style and conventions which introduces the following differences to CSPICE.SPICE.jl does not wrap all CSPICE functions since many general purpose utilities already exist in Julia\'s standard library or can be approximated with a Julia one-liner.  If you try to call an unwrapped function, SPICE.jl will return a deprecation warning that shows the equivalent Julia code.\nFunctions that mutate one of their input arguments are suffixed with ! and the to-be-mutated argument will be the first parameter, e.g. wninsd!(window, left, right) instead of wninsd(left, right, window)."
},

{
    ...
    "title": "Next Steps",
    "category": "section",
    "text": "Please refer to the API reference."
},
